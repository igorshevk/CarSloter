...
if(isset($_POST['save']))
{
   ...
   $stmt=$conn->prepare("insert into tbl_admin (adm_uid,adm_password,adm_type,adm_name,adm_status)values(:adm_uid,:adm_password,:adm_type,:adm_name,:adm_status)");	
   $stmt->bindParam(":adm_uid",$adm_uid, PDO::PARAM_STR);
   $stmt->bindParam(":adm_password",$adm_password, PDO::PARAM_STR);
    $stmt->bindParam(":adm_type",$adm_type, PDO::PARAM_STR);
   $stmt->bindParam(":adm_name",$adm_name, PDO::PARAM_STR);
    $stmt->bindParam(":adm_status",$adm_status, PDO::PARAM_STR);
   $result=$stmt->execute();
   if($result)
   {
...
<head>
  <meta charset="utf-8">
    ...
    <link rel="icon" href="images/favicon.ico">
      ...
      <title><?=SITE_NAME;?> | Add Agent</title>
          ...
          <div class="row">
            <div class="col-12">
            	...
            	<div class="form-group row" id="#frmgrp">
				  ...
				  <div class="col-sm-10">
					<input type="text" class="form-control" name="adm_uid" required="">
				  </div>
				</div>
				...
				<div class="form-group row" id="#frmgrp">
				  ...
				  <div class="col-sm-10">
					<input type="text" class="form-control" name="adm_password" required="">
				  </div>
				</div>
