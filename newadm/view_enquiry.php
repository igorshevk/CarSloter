...
<head>
  <meta charset="utf-8">
   ...
   <title><?=SITE_NAME;?> |View Enquiry</title>
              ...
              <table class="table table-bordered table-striped table-responsive">
                <tbody>
					<tr>
						...
						<td style="width:50%;"><?=$row->enq_name;?></td>
					</tr>
					
					<tr>
						<th style="width:50%;">Mobile No.</th>
						<td style="width:50%;"><?=$row->enq_mobile;?></td>
					</tr>
					
					<tr>
						<th style="width:50%;">Email Id</th>
						<td style="width:50%;"><?=$row->enq_email;?></td>
					</tr>
					
					<tr>
						<th style="width:50%;">Subject</th>
						<td style="width:50%;"><?=$row->enq_subject;?></td>
					</tr>
					
					<tr>
						<th style="width:50%;">Message</th>
						<td style="width:50%;"><?=$row->enq_message;?></td>
					</tr>
