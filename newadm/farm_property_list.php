...
<head>
  <meta charset="utf-8">
   ...
   <title><?=SITE_NAME;?> | Farm Property List</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
	    <a href="add_farm_property.php" class="btn btn-info">Add Farm Property</a>
      </h1>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="myaccount.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="breadcrumb-item active">Farm Property List</li>
      </ol>
    </section>
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped table-responsive">
				...
				<tbody>
					...
					<?php
					$stmt=$conn->prepare("select * from tbl_property where p_category = 3 order by id DESC");
					$sno=1;
					$stmt->execute();
					...
					?>
					 <tr>
						...
						<td>
						&nbsp;&nbsp;&nbsp;<a href="edit_farm_property.php?id=<?=$row->id;?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;<a href="farm_property_list.php?id=<?=$row->id;?>" onclick="return checkDelete()"><i class="fa fa-trash" aria-hidden="true"></i></a>
						</td>
					</tr>
					<?php $sno++; } ?>
				</tbody>
