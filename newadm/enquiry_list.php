...
{
 $enqid=$_GET['enqid'];
 $sql=$conn->prepare("delete from tbl_enquiry where enq_id='$enqid'");
 $result=$sql->execute();
 if($result)
 {
...
<head>
  <meta charset="utf-8">
   ...
   <title><?=SITE_NAME;?> | Enquiry List</title>
              ...
              <table id="example1" class="table table-bordered table-striped table-responsive">
                <thead>
					<tr style="background-color:#122F3B;">
						...
						<th style="width:20%;color:#fff;">Mobile No</th>
						<th style="width:20%;color:#fff;">Email Id</th>
				...
				<tbody>
					...
					<?php
					$stmt=$conn->prepare("select * from tbl_enquiry order by enq_id DESC");
					$sno=1;
					$stmt->execute();
					...
					?>
					 <tr>
                       ...
                       ?>
						...
						<td>
						&nbsp;&nbsp;&nbsp;<a href="view_enquiry.php?enqid=<?=$row->enq_id;?>"><i class="fa fa-eye" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;<a href="enquiry_list.php?enqid=<?=$row->enq_id;?>" onclick="return checkDelete()"><i class="fa fa-trash" aria-hidden="true"></i></a>
						</td>
					</tr>
					<?php $sno++; } ?>
				</tbody>
