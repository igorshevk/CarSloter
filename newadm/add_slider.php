...
if(isset($_POST['save']))
{
    ...
    $stmt=$conn->prepare("insert into tbl_slider(slider_title,slider_image,slider_date,slider_status)values(:slider_title,:nslider_img,:slider_date,:slider_status)");	
...
<head>
  <meta charset="utf-8">
    ...
    <link rel="icon" href="images/favicon.ico">
      ...
      <title><?=SITE_NAME;?> | Add Slider</title>
          ...
          <div class="row">
            <div class="col-12">
            	...
            	<div class="form-group row">
				  ...
				  <div class="col-sm-10">
					<textarea class="form-control" name="slider_title" required="" placeholder="Slider Title"></textarea>
				  </div>
				</div>
				...
				<div class="form-group row">
				  ...
				  <div class="col-sm-10">
					<input type="date" class="form-control" name="slider_date" required="">
				  </div>
				</div>
				...
				<div class="form-group row">
				  ...
				  <div class="col-sm-10">
					<input type="submit" class="btn btn-success" name="save" value="Save Slider">
				  </div>
				</div>
		     	</form>
