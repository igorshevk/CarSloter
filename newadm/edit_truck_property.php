...
$sql=$conn->prepare("select * from tbl_property where id='$id'");
$sql->execute();
...
<head>
  <meta charset="utf-8">
    ...
    <link rel="icon" href="images/favicon.ico">
      ...
      <title><?=SITE_NAME;?> | Edit Truck Property</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"> Edit Truck Property</li>
      </ol>
    </section>
          ...
          <div class="row">
            <div class="col-12">
				...
				<div class="form-group row">
				  <label for="example-text-input" class="col-sm-2 col-form-label">Property Status</label>
				  <div class="col-sm-10">
					<select class="form-control" name="status">
                      <option value="0" <?php if($row->status=='') {echo "selected='selected'"; }?>>--Select Status--</option>
				...
				<div class="form-group row">
				  ...
				  <div class="col-sm-10">
					<input type="submit" class="btn btn-success" name="update" value="Update Property">
				  </div>
				</div>
		     	</form>
				<?php
	           ...
	           $name=$_POST['name'];
	           $status=$_POST['status'];
               $stmt=$conn->prepare("update tbl_property set name=:name,status=:status where id=:id");	
               ...
               if($result)
               {
	           echo "<script>window.location.href='truck_property_list.php'</script>";
              }
              }
			  ?>
