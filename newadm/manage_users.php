              ...
              <table id="example1" class="table table-bordered table-striped table-responsive">
                <thead>
					<tr style="background-color:#122F3B;">
						...
						<th style="width:20%;color:#fff;">Enail Id </th>
						<th style="width:20%;color:#fff;">Phone No</th>
				...
				<tbody>
					...
					<?php
					$stmt=$conn->prepare("select * from tbl_users order by u_id DESC");
					$sno=1;
					$stmt->execute();
					...
					?>
					 <tr>
                       ...
                       ?>
						...
						<td>
						&nbsp;&nbsp;&nbsp;<a href="user_detail.php?uid=<?=$row->u_id;?>"><i class="fa fa-eye" aria-hidden="true"></i></a>
						&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;<a href="edit_user.php?uid=<?=$row->u_id;?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;<a href="manage_users.php?uid=<?=$row->u_id;?>" onclick="return checkDelete()"><i class="fa fa-trash" aria-hidden="true"></i></a>
						</td>
						<?php }else { ?>
						<td>
							&nbsp;&nbsp;&nbsp;<a href="user_detail.php?uid=<?=$row->u_id;?>"><i class="fa fa-eye" aria-hidden="true"></i></a>
