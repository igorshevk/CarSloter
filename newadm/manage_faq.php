...
{
 $faqid=$_GET['faqid'];
 $sql=$conn->prepare("delete from tbl_faq where faq_id='$faqid'");
 $result=$sql->execute();
 if($result)
 {		
...
<head>
  <meta charset="utf-8">
   ...
   <title><?=SITE_NAME;?> | Faq List</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      <a href="add_faq.php" class="btn btn-info">Add Faq</a>
      </h1>
      <ol class="breadcrumb">
              ...
              <table id="example1" class="table table-bordered table-striped table-responsive">
                <thead>
					<tr style="background-color:#122F3B;">
						...
						<th style="width:25%;color:#fff;">Question</th>
				...
				<tbody>
					...
					<?php
					$stmt=$conn->prepare("select * from tbl_faq order by faq_id DESC");
					$sno=1;
					$stmt->execute();
					...
					?>
					 <tr>
						...
						<td>
						&nbsp;&nbsp;&nbsp;<a href="edit_faq.php?faqid=<?=$row->faq_id;?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;<a href="manage_faq.php?faqid=<?=$row->faq_id;?>" onclick="return checkDelete()"><i class="fa fa-trash" aria-hidden="true"></i></a>
						</td>
					</tr>
					<?php $sno++; } ?>
				</tbody>
