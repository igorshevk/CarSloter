...
if(isset($_POST['save']))
{
	...
	$gallery_img=$_FILES['g_image']['name'];
    ...
    $stmt=$conn->prepare("insert into tbl_gallery(g_title,g_image,g_status)values(:g_title,:ngallery_img,:g_status)");	
...
<head>
  <meta charset="utf-8">
    ...
    <link rel="icon" href="images/favicon.ico">
      ...
      <title><?=SITE_NAME;?> | Add Gallery</title>
          ...
          <div class="row">
            <div class="col-12">
            	...
            	<div class="form-group row">
				  ...
				  <div class="col-sm-10">
					<textarea class="form-control" name="g_title" required="" placeholder="Image Title"></textarea>
				  </div>
				</div>
				...
				<div class="form-group row">
				  ...
				  <div class="col-sm-10">
					<input type="file" class="form-control" name="g_image" required="">
				  </div>
				</div>
				...
				<div class="form-group row">
				  ...
				  <div class="col-sm-10">
					<input type="submit" class="btn btn-success" name="save" value="Save Gallery">
				  </div>
				</div>
		     	</form>
