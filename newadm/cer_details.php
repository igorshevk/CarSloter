...
exit;
$stmt_oid=$conn->prepare("SELECT * FROM tbl_order where order_pid='$pid' AND ip_address='$ip_address'");
$stmt_oid->execute();
$row_oid=$stmt_oid->fetch(PDO::FETCH_OBJ);
$orders=$row_oid->order_status;
if($orders!="")
{
	echo "hiii";
} else 
...
<ul class="nav nav-tabs">
  ...
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
     ...
     <label>Item:</label> <?php echo '17990'+$row_p->p_id;?> <br>
