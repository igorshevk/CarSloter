...
<head>
  <meta charset="utf-8">
    ...
    <link rel="icon" href="images/favicon.ico">
      ...
      <title><?=SITE_NAME;?> | Edit Farm Property</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"> Edit Farm Property</li>
      </ol>
    </section>
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-12">
               ...
               if($result)
               {
	           echo "<script>window.location.href='farm_property_list.php'</script>";
              }
              }
			  ?>
