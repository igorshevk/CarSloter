...
{
 $admid=$_GET['admid'];
 $sql=$conn->prepare("delete from tbl_admin where adm_id='$admid'");
 $result=$sql->execute();
 if($result)
 {
...
<head>
  <meta charset="utf-8">
   ...
   <title><?=SITE_NAME;?> | Manage Agent</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
	    <a href="add_agent.php" class="btn btn-info">Add Agent</a>
      </h1>
      <ol class="breadcrumb">
              ...
              <table id="example1" class="table table-bordered table-striped table-responsive">
                <thead>
					<tr style="background-color:#122F3B;">
						...
						<th style="width:25%;color:#fff;">Agent Name</th>
				...
				<tbody>
					...
					?>
					 <tr>
						...
						<td>
						&nbsp;&nbsp;&nbsp;<a href="edit_agent.php?admid=<?=$row->adm_id;?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;<a href="manage_agent.php?admid=<?=$row->adm_id;?>" onclick="return checkDelete()"><i class="fa fa-trash" aria-hidden="true"></i></a>
						</td>
					</tr>
					<?php $sno++; } ?>
				</tbody>
