...
{
 $oid=$_GET['oid'];
 $sql=$conn->prepare("delete from tbl_origin where o_id='$oid'");
 $result=$sql->execute();
 if($result)
 {
...
<head>
  <meta charset="utf-8">
   ...
   <title><?=SITE_NAME;?> | Origin List</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
	    <a href="add_origin.php" class="btn btn-info">Add Origin</a>
      </h1>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="myaccount.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="breadcrumb-item active">Origin List</li>
      </ol>
    </section>
              ...
              <table id="example1" class="table table-bordered table-striped table-responsive">
                <thead>
					<tr style="background-color:#122F3B;">
						...
						<th style="width:30%;color:#fff;">Origin Name</th>
				...
				<tbody>
					...
					<?php
					$stmt=$conn->prepare("select * from tbl_origin order by o_id DESC");
					$sno=1;
					$stmt->execute();
					...
					?>
					 <tr>
						...
						<td>
						&nbsp;&nbsp;&nbsp;<a href="edit_origin.php?oid=<?=$row->o_id;?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;<a href="origin_list.php?oid=<?=$row->o_id;?>" onclick="return checkDelete()"><i class="fa fa-trash" aria-hidden="true"></i></a>
						</td>
					</tr>
					<?php $sno++; } ?>
				</tbody>
