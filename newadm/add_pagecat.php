...
if(isset($_POST['save']))
{
   ...
   $stmt=$conn->prepare("insert into tbl_pagecat (pcat_name,pcat_status)values(:pcat_name,:pcat_status)");	
          ...
          <div class="row">
            <div class="col-12">
            	...
            	<div class="form-group row" id="#frmgrp">
				  ...
				  <div class="col-sm-10">
					<input type="text" class="form-control" name="pcat_name" required="">
				  </div>
				</div>
