...
$title = 'Bid Lost';
$subjectTitle = 'Your bid has been declined';
$messageHeader = 'Hello '.$userfname.' '.$userlname.',';
$messageContent = 'One of your latest order was surpassed. !<span>&nbsp;</span><br><br><br>You can see all the items in your account area.';
$imageUrl = 'https://www.carsloter.eu/img/bidlose.jpg';
...
// More headers
$headers .= 'From: CarSloter <bid-reject@carsloter.eu>' . "\r\n";
///$headers .= 'Cc: Carolgreen281@gmail.com' . "\r\n";
$a=mail($to,$subject,$message,$headers,'-fbid-reject@carsloter.eu');
