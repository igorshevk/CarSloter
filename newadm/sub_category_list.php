...
<head>
  <meta charset="utf-8">
   ...
   <title><?=SITE_NAME;?> | Car Model List</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
	    <a href="add_sub_category.php" class="btn btn-info">Add Car Model</a>
      </h1>
      <ol class="breadcrumb">
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped table-responsive">
				...
				<tbody>
					...
					<?php
					$stmt=$conn->prepare("select * from tbl_subcategory order by scat_id DESC");
					$sno=1;
					$stmt->execute();
					...
					?>
					 <tr>
						...
						<td>
						&nbsp;&nbsp;&nbsp;<a href="edit_sub_category.php?sid=<?=$row->scat_id;?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;<a href="sub_category_list.php?sid=<?=$row->scat_id;?>" onclick="return checkDelete()"><i class="fa fa-trash" aria-hidden="true"></i></a>
						</td>
					</tr>
					<?php $sno++; } ?>
				</tbody>
