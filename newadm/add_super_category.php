...
if(isset($_POST['save']))
{
   ...
   $stmt=$conn->prepare("insert into tbl_supercategory (supercat_mcat_id,supercat_scat_id,supercat_name,supercat_status)values(:supercat_mcat_id,:supercat_scat_id,:supercat_name,:supercat_status)");	
...
<head>
  <meta charset="utf-8">
    ...
    <link rel="icon" href="images/favicon.ico">
      ...
      <title><?=SITE_NAME;?> | Add Super Category</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"> Add Super Category</li>
      </ol>
    </section>
          ...
          <div class="row">
            <div class="col-12">
				...
				<div class="form-group row">
				  ...
				  <div class="col-sm-10">
					<select class="form-control" name="supercat_mcat_id" onChange="getsubcategory(this.value);">
					  ...
					  <?php $sql=$conn->prepare("select * from tbl_maincategory where mcat_status='1'");
                            $sql->execute();
            	...
            	<div class="form-group row">
				  ...
				  <div class="col-sm-10">
					<input type="text" class="form-control" name="supercat_name" required="">
				  </div>
				</div>
				...
				<div class="form-group row">
				  ...
				  <div class="col-sm-10">
					<input type="submit" class="btn btn-success" name="save" value="Save Category">
				  </div>
				</div>
		     	</form>
