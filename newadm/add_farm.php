...
<title><?=SITE_NAME;?> | Add Farm</title>
...
<li class="breadcrumb-item active"> Add Farm</li>
</ol>
</section>
<!-- Main content -->
...
<?php $sqlProperty=$conn->prepare("SELECT * FROM tbl_property where p_category = 3 and status = 1");
$sqlProperty->execute();
