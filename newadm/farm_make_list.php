...
<head>
  <meta charset="utf-8">
   ...
   <title><?=SITE_NAME;?> | Farm Make List</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
	    <a href="add_farm_make.php" class="btn btn-info">Add Farm Make</a>
      </h1>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="myaccount.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="breadcrumb-item active">Farm Make List</li>
      </ol>
    </section>
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped table-responsive">
				...
				<tbody>
					...
					<?php
					$stmt=$conn->prepare("select * from tbl_maincategory where p_category = 3 order by mcat_id DESC");
					$sno=1;
					$stmt->execute();
					...
					?>
					 <tr>
						...
						<td>
						&nbsp;&nbsp;&nbsp;<a href="edit_farm_make.php?mid=<?=$row->mcat_id;?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;<a href="farm_make_list.php?mid=<?=$row->mcat_id;?>" onclick="return checkDelete()"><i class="fa fa-trash" aria-hidden="true"></i></a>
						</td>
					</tr>
					<?php $sno++; } ?>
				</tbody>
