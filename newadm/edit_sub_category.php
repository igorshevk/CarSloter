...
<head>
  <meta charset="utf-8">
    ...
    <link rel="icon" href="images/favicon.ico">
      ...
      <title><?=SITE_NAME;?> | Edit Car Model</title>
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-12">
				...
				<div class="form-group row">
				  ...
				  <div class="col-sm-10">
					<select class="form-control" name="scat_mcat_id">
					  ...
					  <?php $sql2=$conn->prepare("select * from tbl_maincategory where mcat_status='1' and p_category = 1 order by mcat_name");
                            $sql2->execute();
               ...
               if($result)
               {
	           echo "<script>window.location.href='sub_category_list.php'</script>";
              }
              }
			  ?>
