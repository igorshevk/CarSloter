...
$sql=$conn->prepare("select * from tbl_pages where p_id=:pid");
...
<head>
  <meta charset="utf-8">
    ...
    <link rel="icon" href="images/favicon.ico">
      ...
      <title><?=SITE_NAME;?> | Edit Page</title>
          ...
          <div class="row">
            <div class="col-12">
				  ...
				  <div class="col-sm-10">
					<select class="form-control" name="p_pcatid">
					  ...
					  <?php $sql=$conn->prepare("select * from tbl_pagecat where pcat_status='1'");
							...
							{
					  ?>
					  <option value="<?php echo $row->pcat_id; ?>" <?php if($row->pcat_id==$results->p_pcatid) {echo "selected='selected'";} ?>><?php echo $row->pcat_name; ?></option>
						<?php } ?>
					</select>
				  </div>
				</div>
            	...
            	<div class="form-group row">
				  ...
				  <div class="col-sm-10">
					<textarea class="form-control" name="p_title" required="" placeholder="Page Title"><?=$results->p_title;?></textarea>
				  </div>
				</div>
				...
				<div class="form-group row">
				  ...
				  <div class="col-sm-10">
					<textarea class="form-control" name="p_desc" required="" placeholder="Blog Description"><?=$results->p_desc;?></textarea>
				  </div>
				</div>
				...
				<div class="form-group row">
				  ...
				  <div class="col-sm-10">
					<input type="text" class="form-control" name="p_url" required="" placeholder="Page URL" value="<?=$results->p_url;?>">
				  </div>
				</div>
				...
				<div class="form-group row">
				  ...
				  <div class="col-sm-10">
					<select class="form-control" name="p_status">
                      <option value="0" <?php if($results->p_status=='') echo "selected='selected'"; ?>>--Select Status--</option>
					  <option value="1" <?php if($results->p_status=='1') echo "selected='selected'"; ?>>Active</option>
					  <option value="0" <?php if($results->p_status=='0') echo "selected='selected'"; ?>>Inactive</option>
					</select>
				  </div>
				</div>
				...
				if(isset($_POST['update']))
{
    ...
    $stmt=$conn->prepare("update tbl_pages set p_pcatid='$p_pcatid',p_title='$p_title',p_desc='$p_desc',p_url='$p_url',p_status='$p_status' where p_id='$pid'");	
