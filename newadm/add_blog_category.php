...
if(isset($_POST['save']))
{
   ...
   $stmt=$conn->prepare("insert into tbl_blog_category (bcat_name,bcat_status)values(:bcat_name,:bcat_status)");	
...
<head>
  <meta charset="utf-8">
    ...
    <link rel="icon" href="images/favicon.ico">
      ...
      <title><?=SITE_NAME;?> | Add Blog Category</title>
          ...
          <div class="row">
            <div class="col-12">
            	...
            	<div class="form-group row" id="#frmgrp">
				  ...
				  <div class="col-sm-10">
					<input type="text" class="form-control" name="bcat_name" required="">
				  </div>
				</div>
