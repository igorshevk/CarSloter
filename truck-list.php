...
if (isset($_GET['sbmtBtn'])) {
    ...
    if(isset($_GET['Transmission_type']))
...
if($country!='')
{
  $whereClause = $whereClause.' and (Pickup_location = '.$country.')';  
} 
...
if($YearFrom && $YearTo)
    $whereClause = $whereClause.' and ('.$YearFrom.' <= Production_date AND Production_date <= '.$YearTo.')';  
else if($YearFrom && $YearTo == '')
    $whereClause = $whereClause.' and ('.$YearFrom.' <= Production_date)';  
else if($YearFrom == '' && $YearTo)
    $whereClause = $whereClause.' and (Production_date <= '.$YearTo.')';  
...
<div class="main">
<div class="headline">
<h3 class="title"><a href="truck-details.php?pid=<?php echo $id; ?>"><span class="strong"><?php echo $row->name; ?></span> - <?php echo number_format($row->Mileage); ?> KM</a></h3></div>
<h4>Buy now auction</h4>
<div class="cols">
<div class="first-col"><a href="truck-details.php?pid=<?php echo $id; ?>">
...
<a class="show-detail-arrow uitest-show-auction-link" href="truck-details.php?pid=<?php echo $id; ?>"><i class="fa fa-chevron-right"></i></a>
</div>
<?php  } ?>
...
<div class="header">
<div class="headline">
<h3 class="title"><a href="truck-details.php?pid=<?php echo $id; ?>"><span class="strong"><?php echo $row->name; ?></span> - <?php echo number_format($row->Mileage); ?> KM</a></h3>
...
<div class="details">
    </span><span class="data"><?php echo $row->Body_type;?></span>
<?php
$Pickup_location=$row->Pickup_location;
$getFlag=$conn->prepare("select * from tbl_countries WHERE country_id='$Pickup_location'");
$getFlag->execute();
...
<button class="cotw-btn secondary ghost-blue"><a href="truck-details.php?pid=<?php echo $id; ?>">View details</a></button>
</div>
</div>
<?php  } ?>
</div>
