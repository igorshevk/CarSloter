...
<h1><?php echo $row->name; ?> - <?php echo $row->Fuel_type; ?> - <?php echo $row->Transmission_type; ?> - <?php echo $row->Power; ?> - <?php echo number_format($row->Mileage); ?></h1>
...
<li class="active"><a href="#tab3default" data-toggle="tab" role="tab"  aria-expanded="true">Car profile</a></li>
...
<div class=" specification">
	...
	<div class="lines-group">
		<div class="line">
			<div class="row">
				<div class="col-md-6">First registration</div>
				<div data-attr="car-first-registration" class="col-md-6"><?php echo $row->First_registration; ?></div>
			</div>
		</div>
		...
		<div class="line">
			<div class="row">
				<div class="col-md-6">Mileage (in km)</div>
		...
		<div class="line">
			<div class="row">
				...
				<div data-attr="car-fuel" class="col-md-6"><?php echo $row->Fuel_type; ?></div>
			</div>
		</div>

		<div class="line">
			<div class="row">
				<div class="col-md-6">Transmission type</div>
				<div data-attr="car-transmission" class="col-md-6"><?php echo $row->Transmission_type; ?></div>
			</div>
		</div>

		<div class="line">
			<div class="row">
				<div class="col-md-6">CO² emission standard</div>
				<div data-attr="car-emission" class="col-md-6"><?php echo $row->CO2_emission_standard; ?></div>
			</div>
		</div>

		<div class="line">
			<div class="row">
				<div class="col-md-6">CO² emission (minimum value)</div>
				<div data-attr="car-emission" class="col-md-6"><?php echo $row->CO2_emission; ?></div>
			</div>
		</div>
		...
		<div class="line">
			<div class="row">
				...
				<div data-attr="car-kw" class="col-md-6"><?php echo $row->Power; ?></div>
			</div>
		</div>

		<div class="line">
			<div class="row">
				<div class="col-md-6">Engine size</div>
				<div data-attr="car-engine" class="col-md-6"><?php echo $row->Engine_size; ?></div>
			</div>
		</div>
		...
		<div class="line">
			<div class="row">
				<div class="col-md-6">Doors</div>
				<div data-attr="car-doors" class="col-md-6"><?php echo $row->Doors; ?></div>
			</div>
		</div>

		<div class="line">
			<div class="row">
				<div class="col-md-6">Number of places</div>
				<div data-attr="car-places" class="col-md-6"><?php echo $row->Number_of_places; ?></div>
			</div>
		</div>
		...
		<div class="line">
			<div class="row">
				<div class="col-md-6">Number of keys</div>
				<div class="col-md-6"><?php echo $row->Number_of_keys; ?></div>
			</div>
		</div>

		<div class="line">
			<div class="row">
				<div class="col-md-6">Paint</div>
				<div data-attr="car-paint" class="col-md-6"><?php echo $row->Paint; ?></div>
			</div>
		</div>

		<div class="line">
			<div class="row">
				<div class="col-md-6">Interior colour</div>
				<div data-attr="car-interior" class="col-md-6"><?php echo $row->Interior_colour; ?></div>
			</div>
		</div>

		<div class="line">
			<div class="row">
				<div class="col-md-6">Tread depth (mm)</div>
				<div class="col-md-6">5 mm (front), 3 mm (rear)</div>
			</div>
		</div>
	</div>
	...
	<div class="lines-group">
		<div class="line">
			<div class="row">
				<div class="col-md-6">Car registration document(s)</div>
				<div class="col-md-6"><?php echo $row->Car_registration_document; ?></div>
			</div>
		</div>

		<div class="line">
			<div class="row">
				<div class="col-md-6">Certificate of conformity (COC)</div>
				<div class="col-md-6"><?php echo $row->Certificate_of_conformity; ?></div>
			</div>
		</div>

		<div class="line">
			<div class="row">
				<div class="col-md-6">Maintenance records</div>
				<div class="col-md-6"><?php echo $row->Maintenance_records; ?></div>
			</div>
		</div>
	</div>
		...
		<div class="line">
			...
			<div class="line">
				<div class="row">
					...
					$getOrigin=$conn->prepare("select * from tbl_countries WHERE country_id='$Origin'");
					$getOrigin->execute();
					$rowOrigin=$getOrigin->fetch(PDO::FETCH_OBJ);
					?>

					<div class="col-md-6"><img src="newadm/uploaded_file/flag/<?php echo $rowOrigin->country_flag_image; ?>" style="height: 18px;width: 18px;"> <?php echo $rowOrigin->country_name; ?></div>
				</div>
			...
			<div class="line">
				<div class="row">
					<div class="col-md-6">Selling office</div>
					<?php 
					$Selling= $row->Selling_office;
					$getSelling=$conn->prepare("select * from tbl_countries WHERE country_id='$Selling'");
					$getSelling->execute();
					$rowSelling=$getSelling->fetch(PDO::FETCH_OBJ);
					?>

					<div class="col-md-6"><img src="newadm/uploaded_file/flag/<?php echo $rowSelling->country_flag_image; ?>" style="height: 18px;width: 18px;"> <?php echo $rowSelling->country_name; ?></div>
				</div>
			</div>
		</div>
	</div>
...
<div class="detail-group hidden-lg hidden-md">	
	<div class="widget my-quicklinks">
		...
		<h5> <label class="toggle" for="car-profile">Car Profile</label></h5>
		<ul class="toggled">
			<div class=" specification">
				<h3 class="main-title text-left"> Specifications </h3>
				<div class="lines-group">
					<div class="line">
						<div class="row">
							<div class="col-md-6 col-xs-6">First registration</div>
							<div data-attr="car-first-registration" class="col-md-6 col-xs-6"><?php echo $row->First_registration; ?></div>
						</div>
					</div>

					<div class="line">
						<div class="row">
							<div class="col-md-6 col-xs-6">Production date</div>
					...
					<div class="line">
						<div class="row">
							<div class="col-md-6 col-xs-6">Mileage (in km)</div>
					...
					<div class="line">
						<div class="row">
							...
							<div data-attr="car-fuel" class="col-md-6 col-xs-6"><?php echo $row->Fuel_type; ?></div>
						</div>
					</div>

					<div class="line">
						<div class="row">
							<div class="col-md-6 col-xs-6">Transmission type</div>
							<div data-attr="car-transmission" class="col-md-6 col-xs-6"><?php echo $row->Transmission_type; ?></div>
						</div>
					</div>

					<div class="line">
						<div class="row">
							<div class="col-md-6 col-xs-6">CO² emission standard</div>
							<div data-attr="car-emission" class="col-md-6 col-xs-6"><?php echo $row->CO2_emission_standard; ?></div>
						</div>
					</div>

					<div class="line">
						<div class="row">
							<div class="col-md-6 col-xs-6">CO² emission (minimum value)</div>
							<div data-attr="car-emission" class="col-md-6 col-xs-6"><?php echo $row->CO2_emission; ?></div>
						</div>
					</div>

					<div class="line">
						<div class="row">
							<div class="col-md-6 col-xs-6">Power</div>
							<div data-attr="car-kw" class="col-md-6 col-xs-6"><?php echo $row->Power; ?></div>
						</div>
					</div>

					<div class="line">
						<div class="row">
							<div class="col-md-6 col-xs-6">Engine size</div>
							<div data-attr="car-engine" class="col-md-6 col-xs-6"><?php echo $row->Engine_size; ?></div>
						</div>
					</div>
					...
					<div class="line">
						<div class="row">
							<div class="col-md-6 col-xs-6">Doors</div>
							<div data-attr="car-doors" class="col-md-6 col-xs-6"><?php echo $row->Doors; ?></div>
						</div>
					</div>

					<div class="line">
						<div class="row">
							<div class="col-md-6 col-xs-6">Number of places</div>
							<div data-attr="car-places" class="col-md-6 col-xs-6"><?php echo $row->Number_of_places; ?></div>
						</div>
					</div>
					...
					<div class="line">
						<div class="row">
							<div class="col-md-6 col-xs-6">Number of keys</div>
							<div class="col-md-6 col-xs-6"><?php echo $row->Number_of_keys; ?></div>
						</div>
					</div>

					<div class="line">
						<div class="row">
							<div class="col-md-6 col-xs-6">Paint</div>
							<div data-attr="car-paint" class="col-md-6 col-xs-6"><?php echo $row->Paint; ?></div>
						</div>
					</div>

					<div class="line">
						<div class="row">
							<div class="col-md-6 col-xs-6">Interior colour</div>
							<div data-attr="car-interior" class="col-md-6 col-xs-6"><?php echo $row->Interior_colour; ?></div>
						</div>
					</div>

					<div class="line">
						<div class="row">
							<div class="col-md-6 col-xs-6">Tread depth (mm)</div>
							<div class="col-md-6 col-xs-6">5 mm (front), 3 mm (rear)</div>
						</div>
					</div>
				</div>
				...
				<div class="lines-group">
					<div class="line">
						<div class="row">
							<div class="col-md-6 col-xs-6">Car registration document(s)</div>
							<div class="col-md-6 col-xs-6"><?php echo $row->Car_registration_document; ?></div>
						</div>
					</div>

					<div class="line">
						<div class="row">
							<div class="col-md-6 col-xs-6">Certificate of conformity (COC)</div>
							<div class="col-md-6 col-xs-6"><?php echo $row->Certificate_of_conformity; ?></div>
						</div>
					</div>

					<div class="line">
						<div class="row">
							<div class="col-md-6 col-xs-6">Maintenance records</div>
							<div class="col-md-6 col-xs-6"><?php echo $row->Maintenance_records; ?></div>
						</div>
					</div>
				</div>
				...
				<div class="lines-group">
					<div class="line">
						...
						<div class="line">
							<div class="row">
								<div class="col-md-6 col-xs-6">Origin country</div>
								<?php 
								$Origin= $row->Origin_country;
								$getOrigin=$conn->prepare("select * from tbl_countries WHERE country_id='$Origin'");
								$getOrigin->execute();
								...
								<div class="col-md-6 col-xs-6"><img src="newadm/uploaded_file/flag/<?php echo $rowOrigin->country_flag_image; ?>" style="height: 18px;width: 18px;"> <?php echo $rowOrigin->country_name; ?></div>
							</div>
						...
						<div class="line">
							<div class="row">
								<div class="col-md-6 col-xs-6">Selling office</div>
								<?php 
								$Selling= $row->Selling_office;
								$getSelling=$conn->prepare("select * from tbl_countries WHERE country_id='$Selling'");
								$getSelling->execute();
								...
								<div class="col-md-6 col-xs-6"><img src="newadm/uploaded_file/flag/<?php echo $rowSelling->country_flag_image; ?>" style="height: 18px;width: 18px;"> <?php echo $rowSelling->country_name; ?></div>
							</div>
						</div>
					</div>
				</div>
...
<div class="row"><div class="col-md-12"><h2>Similar Cars</h2></div></div>
...
<?php
$stmt=$conn->prepare("select * from tbl_products where category = 1 order by id DESC LIMIT 12");
$stmt->execute();
