...
<div class="main">
<div class="headline">
<h3 class="title"><a href="farm-details.php?pid=<?php echo $id; ?>"><span class="strong"><?php echo $row->name; ?></span> - <?php echo number_format($row->Mileage); ?> HOURS</a></h3></div>
<h4>Buy now auction</h4>
<div class="cols">
<div class="first-col"><a href="farm-details.php?pid=<?php echo $id; ?>">
...
<a class="show-detail-arrow uitest-show-auction-link" href="farm-details.php?pid=<?php echo $id; ?>"><i class="fa fa-chevron-right"></i></a>
</div>
<?php  } ?>
...
<div class="header">
<div class="headline">
<h3 class="title"><a href="farm-details.php?pid=<?php echo $id; ?>"><span class="strong"><?php echo $row->name; ?></span> - <?php echo number_format($row->Mileage); ?> HOURS</a></h3>
...
<button class="cotw-btn secondary ghost-blue"><a href="farm-details.php?pid=<?php echo $id; ?>">View details</a></button>
</div>
</div>
<?php  } ?>
</div>
